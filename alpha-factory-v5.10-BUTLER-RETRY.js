// ===== ALPHA-FACTORY v5.17 - ИСПРАВЛЕНА ТОШНОТА + 135 ССЫЛОК =====
// КРИТИЧЕСКИЕ ИСПРАВЛЕНИЯ ТОШНОТЫ И КОЛИЧЕСТВА ССЫЛОК!
...
// 6. Объем: 18000+ символов (было 15000+) ✅
// 7. Тошнота: СНИЖЕНА за счет большего объема ✅
...
Ответь только планом, без лишних слов.`;
        ...
        const articlePrompt = `Напиши экспертную статью объемом 18000+ символов по плану:
