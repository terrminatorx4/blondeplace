// ===== ALPHA-FACTORY v5.18 - АНТИТОШНОТА: 25000+ СИМВОЛОВ =====
// КРИТИЧЕСКАЯ БОРЬБА С ТОШНОТОЙ + 135 ССЫЛОК!
...
// 6. Объем: 25000+ символов (было 18000+) ✅
// 7. Тошнота: ЦЕЛЕВАЯ 4.5 (синонимы + объем) ✅
// 8. ПЛАН: 100 на основной + 35 внутренних ✅
...
Ответь только планом, без лишних слов.`;
        ...
        // Шаг 2: Генерация статьи с КРИТИЧЕСКИ НИЗКОЙ ТОШНОТОЙ
        const articlePrompt = `Напиши экспертную статью объемом 25000+ символов по плану:
...
КРИТИЧЕСКИЕ ТРЕБОВАНИЯ ДЛЯ НИЗКОЙ ТОШНОТЫ:
- ОБЯЗАТЕЛЬНО 25000+ символов для снижения плотности ключевых слов
- МАКСИМАЛЬНО избегай повторов основного ключевого слова
- Используй синонимы: "${keyword}" = "услуга", "вариант", "решение", "предложение"
- Добавляй большие блоки про историю, тренды, статистику
- Включи подробные описания процессов, технологий
- Пиши развернутые кейсы клиентов (не менее 500 слов каждый)
- Добавь раздел "Частые вопросы" с детальными ответами
- Включи сравнительные таблицы и анализ конкурентов
- Пиши от лица эксперта индустрии красоты
- БЕЗ вводных фраз типа "Конечно, вот статья"!
- КАЖДЫЙ абзац минимум 3-4 предложения
- Используй больше общих слов: "качество", "профессионал", "эксперт", "решение"

ЦЕЛЬ: Тошнота НЕ ВЫШЕ 4.5 благодаря большому объему и разнообразию!
