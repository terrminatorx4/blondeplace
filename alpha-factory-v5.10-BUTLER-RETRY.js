// ===== ALPHA-FACTORY v5.19 - ЭКСТРЕМАЛЬНАЯ АНТИТОШНОТА =====
// КАРДИНАЛЬНЫЕ МЕРЫ: 30000+ СИМВОЛОВ + ЗАПРЕТ ПОВТОРОВ!
...
// 6. Объем: 30000+ символов (было 25000+) ✅
// 7. Тошнота: ЦЕЛЕВАЯ 4.0 (ЗАПРЕТ на повторы) ✅
// 8. Стратегия: 70% текста БЕЗ ключевых слов ✅
...
Ответь только планом, без лишних слов.`;
        ...
        // Шаг 2: Генерация статьи с ЭКСТРЕМАЛЬНО НИЗКОЙ ТОШНОТОЙ
        const articlePrompt = `Напиши экспертную статью объемом 30000+ символов по плану:
...
🚫 КРИТИЧЕСКИЙ ЗАПРЕТ НА ТОШНОТУ:
- АБСОЛЮТНО ЗАПРЕЩЕНО повторять слово "${keyword}" более 15 раз!
- ЗАМЕНЯЙ "${keyword}" на: "услуга", "предложение", "вариант", "решение", "возможность", "сервис", "опция"
- ИСПОЛЬЗУЙ общие термины: "профессиональная помощь", "качественное обслуживание", "экспертное решение"
- НЕ ПИШИ "${keyword}" в каждом абзаце!

📚 ОБЯЗАТЕЛЬНЫЕ РАЗДЕЛЫ БЕЗ КЛЮЧЕВЫХ СЛОВ (минимум 10000 символов):
1. "История индустрии красоты в России" (1500+ слов)
2. "Современные тренды в beauty-сфере 2025" (1500+ слов) 
3. "Технологические инновации в салонах" (1500+ слов)
4. "Психология клиентского сервиса" (1500+ слов)
5. "Экономические аспекты beauty-бизнеса" (1500+ слов)
6. "Правовое регулирование индустрии" (2000+ слов)

📖 ТРЕБОВАНИЯ К ОБЪЕМУ:
- ОБЯЗАТЕЛЬНО 30000+ символов
- Каждый раздел минимум 4-5 абзацев
- Каждый абзац минимум 5-6 предложений
- Добавляй статистику, цифры, даты
- Включай цитаты экспертов (выдуманные)
- Пиши подробные технические описания

🔄 СТРАТЕГИЯ РАЗБАВЛЕНИЯ:
- 70% текста НЕ должно содержать "${keyword}"
- Говори про "beauty-индустрию", "салонный бизнес", "клиентский сервис"
- Используй профессиональную терминологию
- Добавляй исторические факты и статистику

ЦЕЛЬ: Тошнота СТРОГО НЕ ВЫШЕ 4.0!
