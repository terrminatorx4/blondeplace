...
- КРИТИЧНО: ЗАПРЕЩЕНО повторять слова! Тошнота СТРОГО до 4.5! Каждое предложение - уникальные слова, синонимы, перифразы. Абзацы максимально разнообразные!
...
- "title" (СТРОГО 40-43 символа, включи основное ключевое слово)
- "description" (СТРОГО 155-160 символов, продающий, с призывом к действию)
